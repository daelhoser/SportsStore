        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product { Name = "Corner Flags", Description = "Give your playing field a professional tough", Category = "Soccer", Price = 34.95m },
                    new Product { Name = "Stadium", Description = "Flat-packed 35,000-seat stadium", Category = "Soccer", Price = 79.50m, },
